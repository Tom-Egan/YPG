    ...
    <div class="container subpage-body">
        ...
        -->
            <?php
                ...
                $xml=simplexml_load_file("../xml/portfolio_tree.xml") or die("XML Error: Cannot create object");
                ...
                foreach ($xml as $imgPath):
                    ...
                    echo "<a href='images/tree_service/",$image_name,".jpg' data-lightbox='tree-main' title='' alt='",$alt,"'>";
