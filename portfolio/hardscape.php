...
<head>
    <title>Hardscape Portfolio | Your Personal Gardener</title>
...
<div class="container-fluid subpage-wrap">
    ...
    <div class="container subpage-body">
        ...
        <div class="row">
            <!-- page title -->
            <div class="col-md-6">
                <h1 class="page-title portfolio-title-fix "><span class="accent">Hardscape</span></h1>
        ...
        -->
            <?php
                ...
                $xml=simplexml_load_file("../xml/portfolio_hardscape.xml") or die("XML Error: Cannot create object");
                ...
                foreach ($xml as $imgPath):
                    ...
                    echo "<a href='images/hardscape/",$image_name,".jpg' data-lightbox='hardscape-main' title='' alt='",$alt,"'>";
