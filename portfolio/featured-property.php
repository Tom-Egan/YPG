...
<!--
      ...
      Dependencies:
      - - css/lightbox.css
      - - xml/portfolio_featured_property.xml
...
<head>
    <title>Featured Property | Your Personal Gardener</title>
...
<!-- [PAGE TITLE] -->
<div class="container-fluid subpage-header featured-header">
...
<div class="container-fluid subpage-wrap">
    ...
    <div class="container subpage-body">
        ...
        <div class="row">
            <!-- page title -->
            <div class="col-md-6">
                <h1 class="page-title portfolio-title-fix "><span class="accent">Featured Property</span></h1>
        ...
        -->
            <?php
                ...
                $xml=simplexml_load_file("../xml/portfolio_featured_property.xml") or die("XML Error: Cannot create object");
                ...
                foreach ($xml as $imgPath):
                    ...
                    echo "<a href='images/featured_property/",$image_name,".jpg' data-lightbox='featured--main' title='' alt='",$alt,"'>";
